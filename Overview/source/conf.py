...
# Add any paths that contain locales here, relative to this directory.
locale_dirs = ['locale']
...
project = u'Homegear-Nutzerdokumentation'
...
html_theme = 'sphinx_rtd_hg_theme'
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear-Nutzerdokumentation',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear-Nutzerdokumentation',
     [author], 1)
]
